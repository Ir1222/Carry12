...
```bash
python3 experiments/carrybox_clean_perturb/evaluator_NForce.py --resume_path legged_gym/logs/carrybox_locomotion/Sep15_13-39-45_loaded_velocity_tracking_v1/model_XXXX.pt --command 0.4,0.0,0.0 --seed 1 --steady_carry_warmup 0.20 --steady_duration 5.0 --save_csv
```
