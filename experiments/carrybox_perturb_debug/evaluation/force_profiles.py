"""Force profile definitions for carrybox perturbation evaluation."""
...
def half_sine_scale(elapsed_s, duration_s):
    """Return sin(pi * t / T), sampled at elapsed_s."""
...
def smooth_hold_scale(elapsed_s, ramp_up_s, hold_duration_s, ramp_down_s):
    """Half-cosine ramp up, constant hold, half-cosine ramp down."""
